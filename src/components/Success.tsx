...
const Warning = (props: Props) => {
  ...
  return (
    <button
      className="flex flex-col items-start justify-center sm:col-span-2 cursor-pointer h-fit p-4 py-3 text-left shadow-lg bg-opacity-40 bg-green-600 rounded-md"
      onClick={(e) => {
        e.preventDefault();
        if (props.link) {
          setLoading(true);
