...
const Home: NextPage = () => {
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-end justify-start bg-[url('/background.jpg')] from-[#023047] to-[#219ebc] px-24">
        ...
        <div className="container flex h-[100vh] w-[50%] flex-col items-end justify-start px-4 py-8 text-right font-medium text-gray-700 sm:gap-4 sm:py-16">
          <h1 className="text-2xl font-bold tracking-widest sm:text-5xl">
            Aplikasi Pemenuhan Kebutuhan Gizi <br />
            Pada Penderita{" "}
            <span className="italic text-[#fb8500]">Diabetes Melitus</span>
          </h1>
          <p className="text-lg font-medium tracking-tight text-green-600 sm:text-[20px]">
